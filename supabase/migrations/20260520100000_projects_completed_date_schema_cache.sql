-- Seguindo .harness/patterns/security.md e boundaries.md:
-- conclusao de projeto persiste data real sem afrouxar RLS ou guardrails de negocio.
ALTER TABLE public.projects
  ADD COLUMN IF NOT EXISTS completed_date DATE;

COMMENT ON COLUMN public.projects.completed_date IS
  'Actual completion date informed when a project reaches the completed portfolio stage.';
