...
AS $$
  ...
  SELECT
    (SELECT hours FROM proj_planned_annual),
    (SELECT hours FROM proj_actual_annual),
    (SELECT hours FROM act_planned_annual),
    (SELECT hours FROM act_actual_annual),
    (SELECT hours FROM proj_planned_month),
    (SELECT hours FROM proj_actual_month),
    (SELECT hours FROM act_planned_month),
    (SELECT hours FROM act_actual_month)
$$;