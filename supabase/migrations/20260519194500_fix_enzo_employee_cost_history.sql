...
BEGIN
  SELECT count(*), min(id), max(cargo)
  INTO v_match_count, v_employee_id, v_current_cargo
  ...
  WHERE employee_id = v_employee_id
    AND effective_from >= DATE '2026-01-05';
  ...
  VALUES
    (
      v_employee_id,
      'VR/VA',
      'Vale refeição/alimentação estágio vigente desde 2026-03-01',
      400.000000,
      true,
      'MIGRATION',
      'vr_va_2026_03',
  ...
  VALUES
    (
      v_employee_id,
      'MS365',
      'Microsoft 365 F1 desde a admissão',
      15.750000,
      true,
      'monthly',
      0.000000,
