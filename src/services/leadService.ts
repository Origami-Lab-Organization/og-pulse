...
export async function fetchLeads(tenantId: string): Promise<LeadWithBudget[]> {
  const { data, error } = await supabase
    ...
    .select(`
      *,
      budget:budgets!leads_budget_id_fkey(id, budget_number, final_total, status, title, subtotal, total_with_fees, discount_value, duration_months, start_date, monthly_value, is_recurring, is_indefinite),
