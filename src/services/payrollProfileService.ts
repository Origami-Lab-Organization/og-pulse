  ...
  async create(input: CreatePayrollProfileInput): Promise<PayrollProfile> {
    const { data, error } = await supabase
      ...
      .insert({
        ...
        apply_inss_on_vacation: input.applyInssOnVacation ?? true,
