...
export function ProjectPlanningOverviewTab({
  ...
  const handleConfirmExecution = async () => {
    ...
    try {
      ...
      // In-app notifications for all project members
      ...
      toast({
        ...
        description:
          'O projeto foi movido para execução e a equipe foi notificada.',
      });
    } catch {
      toast({
          ...
          <div className="flex items-start justify-between gap-4">
            <div>
              ...
              <p className="mt-1 text-sm text-muted-foreground">
                Cinco verificações antes de habilitar timesheets, alocações
                reais e cobrança.
              </p>
            </div>
          ...
          <div className="px-6 py-4 border-t border-border flex items-center justify-between gap-4 flex-wrap">
            {allDone && (
              <p className="text-sm text-muted-foreground">
                Tudo pronto. Iniciar execução habilita o timesheet de toda a
                equipe.
              </p>
            )}
      ...
      <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
        <DialogContent className="sm:max-w-md">
          ...
          <div className="space-y-4 py-2">
            {/* Warning when checklist is incomplete */}
            {!allDone && (
            ...
            <p className="text-sm text-muted-foreground">
              O timesheet será habilitado para a equipe. Eles serão notificados
              por email e no sistema. Confirmar?
            </p>
          </div>
