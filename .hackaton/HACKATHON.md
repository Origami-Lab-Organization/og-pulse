...
**Mockups / Referências Visuais:**
- [x] Referência de tela existente: `/analytics` (será absorvida).
...
*Guia gerado para o Hackathon Origami Pulse. Ajuste premissas de stack e padrões no `CLAUDE.md` antes de começar.*
